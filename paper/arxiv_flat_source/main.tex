...
\begin{figure}[H]
\centering
\includegraphics[width=0.93\columnwidth]{figures/prior_pipeline_schematic.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\columnwidth]{figures/killer_visual.pdf}
...
ViT $P(\tau{=}0.1) < 3\times 10^{-6}$ & MC & 1,000,000 & 0/1M & 95\% one-sided UB \\
CPPN $B_{\text{NS}}^{\text{cross}}(\tau{=}0.1)\approx 2$ & NS & 50 live & 2.1 bits & $\pm$7\% (App.~E) \\
Uniform $B_{\text{NS}}^{\text{cross}}(\tau{=}0.1)>72$ & NS & 50 live & $>$72 bits & Lower bound \\
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/spectrum_64_comparison.pdf}
\caption{Inductive Bias Spectrum at 64$\times$64: ResNet (green) shows strong structural bias, reaching high scores immediately. ViT (orange) and MLP (red) both flatline near zero---untrained ViT has \emph{no} structural advantage over MLP despite positional embeddings.}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/dip_summary.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/dip_cifar_sanity.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/dip_tiny_sanity.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/scaling_law_comprehensive.pdf}
...
\end{tabular}
\\[2pt]
{\footnotesize $^\dagger$For ViTDecoder/MLPDecoder, dedicated 1,000,000-sample runs yielded 0 hits; the 95\% one-sided upper bound is $3\times 10^{-6}$ and values reported as 0.0\% indicate $<0.0001\%$.}
\\[-2pt]
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/fig1_volume_comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/fig1b_volume_zoomed.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\columnwidth]{figures/mc_ns_coord_calibration_scatter.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\columnwidth]{figures/bits_threshold_curve.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\columnwidth]{figures/fig2_bits_bar_chart.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig3_reconstruction_correlation.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig3b_reconstruction_examples.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/fig4_classification_null.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/fig6_demo_results.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/rgb_thermodynamic_comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/phase_transition_scaling.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\columnwidth]{figures/bias_matrix_simple.pdf}
